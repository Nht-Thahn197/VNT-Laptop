...
@section('content')
    <div class="max-w-2xl">
        <h2 class="text-3xl font-semibold">Thêm danh mục</h2>

        <form method="post" action="{{ route('admin.categories.store') }}" class="mt-6 space-y-4 rounded-3xl border border-line bg-white/80 p-6">
            @csrf
            <div>
